...
---@class gooi.component
---@field onPress fun(self:self, fun:function): self
---@field onRelease fun(self:self, fun:function): self
---@field onMoved fun(self:self, fun:function): self
---
---@field bg fun(self:self, rbga:table): self
---@field fg fun(self:self, rgba:table): self
---@field opacity fun(self:self, opacity:number): self
---@field primary fun(self:self): self
---@field secondary fun(self:self): self
...
---@field make3d fun(self:self): self
---@field makeShadow fun(self:self): self
---
---Button
---@field setText fun(self:self, text:string): self
---@field setIcon fun(self:self, img:love.Image|string): self
---
---@field right fun(self:self): self
---@field left fun(self:self): self
---@field center fun(self:self): self
...
function component.new(t, x, y, w, h, group)
	...
	function c:primary()
		self:bg(component.colors.blue); return self
	end

	function c:success()
		self:bg(component.colors.green); return self
	end

	function c:info()
		self:bg(component.colors.cyan); return self
	end

	function c:warning()
		self:bg(component.colors.orange); return self
	end

	function c:danger()
		self:bg(component.colors.red); return self
	end

	function c:opacity(o)
		self.style.bgColor[4] = o; return self
	end
