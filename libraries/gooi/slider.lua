---@class gooi.slider : gooi.component
---
---@field vertical fun(self)
---@field setValue fun(self, num:number) value is between 0 and 1
---@field getValue fun(self):number get the value between 0 and 1
