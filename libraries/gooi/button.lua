---@class gooi.button : gooi.component
---@field setText fun(self, text:string): self
---@field setIcon fun(self, img:love.Image|string): self
---
---@field right fun(self): self
---@field left fun(self): self
---@field center fun(self): self
