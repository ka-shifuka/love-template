...
---@class gooi.joy : gooi.component
---@field xValue fun(self):number
---@field yValue fun(self):number
---@field noSpring fun(self):self
---@field anyPoint fun(self):self
---@field setDigital fun(self):self
---@field direction fun(self): "l"|"r"|"t"|"b"|"bl"|"br"|"tl"|"tr"
---@field X number
---@field Y number

---@param params gooi.joy_param
---@return gooi.joy
