...
---@field onPress fun(self, fun:function): self
---@field onRelease fun(self, fun:function): self
---@field onMoved fun(self, fun:function): self
---
---@field bg fun(self, rbga:table): self
---@field fg fun(self, rgba:table): self
---@field opacity fun(self, opacity:number): self
---@field primary fun(self): self
---@field secondary fun(self): self
---
---@field setRadius fun(self, radius:number, innerRadius:number): self
---@field border fun(self, width:number, color:table, style:string): self
---@field noGlass fun(self): self
---@field no3D fun(self): self
---@field make3d fun(self): self
---@field makeShadow fun(self): self
