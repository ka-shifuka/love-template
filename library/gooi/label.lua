---@class gooo.label : gooi.component
---
---@field setText fun(self, text:string): gooi.button
---@field setIcon fun(self, img:love.Image|string): gooi.button
---@field right fun(self): gooi.button
---@field left fun(self): gooi.button
---@field center fun(self): gooi.button
